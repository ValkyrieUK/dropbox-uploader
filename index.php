...
if ($_POST) {
    ...
    try {
		...
		$DropboxUploader = new DropboxUploader('USERNAME', 'PASSWORD');
        $DropboxUploader->upload($tmpFile, $_POST['dest']);
...
<div class="box" align="center">
        ...
        <h3>PLTS week video and pics only please</h3>
        <br>
		<br>
		&nbsp;
		<form method="POST" enctype="multipart/form-data">
		<input type="file" name="file" multiple /a><br><br>
